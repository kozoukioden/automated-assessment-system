...
export const ROUTES = {
  ...
  STUDENT_SPEAKING_SUBMISSION: (id) => `/student/activities/speaking/${id}`,
  STUDENT_WRITING_SUBMISSION: (id) => `/student/activities/writing/${id}`,
  STUDENT_QUIZ_SUBMISSION: (id) => `/student/activities/quiz/${id}`,
